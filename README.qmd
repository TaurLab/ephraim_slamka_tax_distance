...
Each subject's samples were collected over several different days, but more than one sample was taken per day. It should be noted that some samples were also sequenced multiple times.
